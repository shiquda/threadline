...
const zhCN: Record<string, string> = {
  ...
  "Select a session to view its records.": "选择一个会话以查看其记录。",
  "Session records": "会话记录",
  "Could not load agents": "无法加载智能体记录",
  "No matching agents": "没有匹配的智能体记录",
  "Agent work will appear here.": "智能体工作记录会显示在这里。",
  "No session recorded": "未记录会话",
  "Unknown host": "未知主机",
  "Unknown tool": "未知工具",
  ...
  "Messages you receive will appear here.": "你收到的消息会显示在这里。",
  ...
  "Decide": "决策",
  "View": "查看",
  "Initiatives grouped by their next state.": "按下一状态分组显示事项。",
  "Ready": "就绪",
  "Waiting": "等待中",
  "Done": "已完成",
  "In progress": "进行中",
  ...
  "Untitled initiative": "未命名事项",
  "Not recorded": "未记录",
  "Owner": "负责人",
  "Next action": "下一行动",
  "Blocker": "阻塞因素",
  "No blocker recorded": "未记录阻塞因素",
  "Recent fact": "最近事实",
  "No recent fact recorded": "未记录最近事实",
  "Record language": "记录语言",
  ...
  "Linked submissions": "关联提交记录",
  "Remove": "移除",
  "Link": "关联",
  "No tasks are linked yet.": "尚未创建任务。",
  "Could not load task": "无法加载任务",
